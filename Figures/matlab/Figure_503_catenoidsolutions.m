% Figure_503_catenoidsolutions.m
% script to plot catenoid shapes in two branches of solutions
...
figure('position',[300 500 1600 400]);
...
%exportgraphics(t,'Goldstein_etal_Figure8.pdf','BackgroundColor','none');
%pause;
hold off;
close; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% catenoids along two branches

t1=figure('position',[900 250 1000 900]);

Dplot_index=[91 291 491 652];

Dplot=[0.1 0.3 0.5 0.662];
...
for n=1:4
    catlow=ar_low(Dplot_index(n))*cosh(y*Dplot(n)/ar_low(Dplot_index(n)));
    cathigh=ar_high(Dplot_index(n))*cosh(y*Dplot(n)/ar_high(Dplot_index(n)));

    plot(catlow+2.3*(n-1),y*Dplot(n),'-r',-catlow+2.3*(n-1),y*Dplot(n),'-r','LineWidth',3);
    plot([-1+2.3*(n-1) 1+2.3*(n-1)],[y(1)*Dplot(n) y(1)*Dplot(n)],'-k','LineWidth',1);
    plot([-1+2.3*(n-1) 1+2.3*(n-1)],[y(200)*Dplot(n) y(200)*Dplot(n)],'-k','LineWidth',1);
    plot(-1+2.3*(n-1),y(1)*Dplot(n),'o',-1+2.3*(n-1),y(200)*Dplot(n),'o','MarkerEdgeColor','k','MarkerFaceColor',[1 0 0],'MarkerSize',10);
    plot(1+2.3*(n-1),y(1)*Dplot(n),'o',1+2.3*(n-1),y(200)*Dplot(n),'o','MarkerEdgeColor','k','MarkerFaceColor',[1 0 0],'MarkerSize',10);

    plot(cathigh+2.3*(n-1),2+y*Dplot(n),'-b',-cathigh+2.3*(n-1),2+y*Dplot(n),'-b','LineWidth',3);
    plot([-1+2.3*(n-1) 1+2.3*(n-1)],[2+y(1)*Dplot(n) 2+y(1)*Dplot(n)],'-k','LineWidth',1);
    plot([-1+2.3*(n-1) 1+2.3*(n-1)],[2+y(200)*Dplot(n) 2+y(200)*Dplot(n)],'-k','LineWidth',1);
    plot(-1+2.3*(n-1),2+y(1)*Dplot(n),'o',-1+2.3*(n-1),2+y(200)*Dplot(n),'o','MarkerEdgeColor','k','MarkerFaceColor',[0 0 1],'MarkerSize',10);
    plot(1+2.3*(n-1),2+y(1)*Dplot(n),'o',1+2.3*(n-1),2+y(200)*Dplot(n),'o','MarkerEdgeColor','k','MarkerFaceColor',[0 0 1],'MarkerSize',10);
end
...
pause;
% exportgraphics(t1,'Figure_catenoidsolutions.png','BackgroundColor','none');
exportgraphics(t1,'Figure_503_catenoidsolutions.pdf','BackgroundColor','white');
